      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-5">
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <Button
              onClick={loadReports}
              className="h-9 px-3 text-sm bg-cyan-500 hover:bg-cyan-600 rounded-xl"
            >
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {[
            ...
            <Button
              ...
              className={
                activeTab === tab
                  ? `${tabStyles[tab as keyof typeof tabStyles]} bg-current/20 rounded-2xl capitalize`
                  : `${tabStyles[tab as keyof typeof tabStyles]} bg-transparent border rounded-2xl capitalize`
              }
            >
              {tab}
            </Button>
        ...
        <Card className="bg-[#040B1A] border border-white/5 rounded-3xl">
          <CardContent className="p-5">
            ...
            <div className="grid md:grid-cols-4 gap-4">
              ...
              <Input
                ...
                className="bg-[#0B1220] border-white/10 rounded-2xl text-white"
              />
              ...
              <select
                ...
                className="bg-[#0B1220] border border-white/10 rounded-2xl px-4 text-white"
              >
                <option value="all">
                  All Branches
                </option>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-[#0B1220] border-white/10 rounded-2xl text-white placeholder:text-white"
                />
          ...
          <>
            ...
            {(() => {
              const unpaidInvoices = invoices.filter(
                (i) =>
                  String(i.payment_status).toUpperCase() !==
                  "PAID"
              );

              const failedPayments = invoices.filter((i) =>
                String(i.payment_status)
                  .toLowerCase()
                  .includes("failed")
              );

              const lowRevenue =
                computed.revenueToday < 5000;
              ...
              const branchPerformance = branches.map(
                (branch) => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mb-6">
                  ...
                  {alerts.map((alert, i) => {
                    ...
                    return (
                      <Card
                        key={i}
                        className={`${alert.color} border rounded-3xl`}
                      >
                        <CardContent className="p-5">
                          ...
                          <div className="flex items-start justify-between">
                            ...
                            <div>
                              ...
                              <h3 className="text-white font-black text-lg mt-2">
                                {alert.value}
                              </h3>
                            </div>

                            <div
                              className={`h-12 w-12 rounded-2xl flex items-center justify-center ${alert.color}`}
                            >
                              <Icon
                                className={`h-6 w-6 ${alert.text}`}
                              />
                            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
              ...
              {kpiCards.map((k, i) => {
                ...
                return (
                  <Card
                    key={i}
                    className="bg-[#040B1A] border border-white/5 rounded-3xl hover:border-cyan-500/20 transition-all"
                  >
                    <CardContent className="p-6 flex items-center justify-between">
                      ...
                      <div>
                        ...
                        <h2
                          className={`text-3xl font-black mt-2 ${valueColor}`}
                        >
                          {k.value}
                        </h2>
                      </div>
