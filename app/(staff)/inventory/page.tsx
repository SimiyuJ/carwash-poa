...
===================================================== */
    ...
    const addStock = async (
        ...
        try {
            ...
            const newQty =
                Number(item.quantity || 0) + quantityToAdd;
    ...
    const restockItem = async (itemId: string) => {
        try {
            ...
            const restockAmount = Number(
                prompt("Enter restock quantity", "10")
            );
            ...
            const newQty =
                Number(item.quantity || 0) + restockAmount;
            ...
            <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                ...
                <div>
                    ...
                    <p className="mt-2 max-w-2xl text-sm text-slate-400">
                        Real-time stock tracking, usage control, and warehouse visibility in one system.
                    </p>
                </div>
