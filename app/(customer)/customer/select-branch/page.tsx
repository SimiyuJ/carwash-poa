...
export default function SelectCarWashPage() {
    console.log("🔥 SelectCarWashPage Rendered");
    ...
    const loadCarwashes = useCallback(async () => {
        console.log("🚀 loadCarwashes started");
  ...
  `)
            ...
            console.error(
                "[SelectCarWash] Unexpected error",
                error
            );
        } finally {
            setLoading(false);
    ...
    useEffect(() => {
        ...
        console.log("Calling loadCarwashes()");
        loadCarwashes();
        ...
        >
            ...
            <div className="space-y-3 p-6">
                ...
                <div className="px-6 pb-6">
                    <button
                        onClick={() =>
                            router.push("/customer/add-carwash")
                        }
                        className="
      w-full
      rounded-2xl
